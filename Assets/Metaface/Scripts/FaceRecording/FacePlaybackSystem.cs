...
public class FacePlaybackSystem : MonoBehaviour
{
    ...
    )
    {
        ...
        {
            throw new System.Exception("The passed weights length is not equal. Expected: " + ExpressionWeights.Length + " but actual: " + weights.Length + " on object " + this.gameObject.name);
        }
