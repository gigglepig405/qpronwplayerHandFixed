...
namespace Metaface.Utilities
{
    ...
    public class BlinkHelper : MonoBehaviour
    {
        ...
        public class BlinkParameter
        {
            ...
            public BlinkParameter(OVRFaceExpressions.FaceExpression faceExpression, float min, float max)
            {
            ...
            public float time = 0;
            public bool hasStartedBlink = false;
        }
        ...
        private void HandleBlinkStopped()
        {
            ...
            if (blinkTime <= maxEyesClosedTime && blinkTime >= minEyesClosedTime)
        ...
        private bool EvaluateExpression(OVRFaceExpressions faceExpressions, params BlinkParameter[] blinkParameters)
        {
            ...
            foreach (BlinkParameter param in blinkParameters)
            {
                ...
                {
                    if (weight < param.Min || weight > param.Max)
                        result = false;
                }
                else
                    result = false;
